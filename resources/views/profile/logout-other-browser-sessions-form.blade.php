<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled" style="background-color:#ff6347;">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2"
                            ...
                            wire:loading.attr="disabled" style="background-color:#ff6347;">
                    {{ __('Logout Other Browser Sessions') }}
                </x-jet-button>
            </x-slot>
        </x-jet-dialog-modal>
